...
files_wide <- files %>%
  ...
  mutate(
    ...
    .before = sample_id
  ) %>% mutate(library=if_else(flowcell=="HCVC5DSX7","lib1",if_else(flowcell=="22HM5LLT4","lib2",if_else(flowcell=="22HVG3LT4","lib3",if_else(flowcell=="22M5VMLT4","lib4",if_else(flowcell=="22T3TYLT4","lib5",if_else(flowcell=="HLYTNAFXY","deroode1",if_else(flowcell=="HLTC7AFXY","deroode2",if_else(flowcell=="HM3NJAFXY","deroode3",if_else(flowcell=="AAAK73JM5","deroode4",if_else(flowcell=="AAAKJL3M5","deroode5",if_else(flowcell=="AAAJVLMM5","deroode6","deroode7"))))))))))))
...
write_tsv(units, file = "monarch.units.tsv")
```
